...
const SIDEBAR_COLLAPSED_KEY = "brainsentry.sidebar.collapsed";
    ...
    () => [
      ...
      },
      {
        ...
        items: [
          ...
          { kind: "item", id: "models", title: t("nav.models"), href: "/app/models", icon: Cpu },
  ...
  return (
    <div className="h-screen flex flex-col md:flex-row overflow-hidden">
      ...
      <aside
        ...
        className={cn(
          "hidden md:flex flex-col border-r bg-muted/40 h-screen transition-[width] duration-200",
          collapsed ? "w-14" : "w-64",
        )}
      >
        <div
          className={cn(
            "border-b bg-gradient-to-r from-brain-primary/10 to-brain-accent/10",
            collapsed
              ? "px-2 py-3 flex flex-col items-center gap-2"
              : "px-4 py-[14px] flex items-center justify-between gap-2",
          )}
        >
          {!collapsed && (
            <div className="flex items-center gap-2 min-w-0">
              <img src="/images/brainsentry_logo.png" alt="Brain Sentry" className="h-8 w-auto flex-shrink-0" />
          ...
          {collapsed && (
            <img src="/images/brainsentry_logo.png" alt="Brain Sentry" className="h-6 w-auto" />
          )}
          <button
            type="button"
        ...
        >
          {collapsed ? renderRail() : renderNavTree()}
        </nav>
      ...
      <main className="flex-1 overflow-y-auto min-h-0 relative">
        ...
        {helpAvailable && (
          <button
            ...
            className={cn(
              "fixed bottom-5 left-5 z-40 flex items-center gap-2 rounded-full shadow-lg transition-[left,padding] duration-200",
